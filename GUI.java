 ...
 public class GUI {
     ...
     private static void login_Panel() {
         ...
         JLabel vraagPas = new JLabel("Your card please");
         vraagPas.setBounds(frame.getWidth()/2-100,frame.getHeight()/2-250,500,50);
         vraagPas.setFont(new Font("Didact Gothic", Font.PLAIN, 30));
         vraagPas.setForeground(new Color(192, 27, 28));
         login_Panel.add(vraagPas);

         String pasnummer  = " FA CF 06 0B";
         ...
         comPort.addDataListener(new SerialPortDataListener() {
             ...
             public void serialEvent(SerialPortEvent event)
             {
                 ...
                 if(serialData.equals(pasnummer)){
                     System.out.println("pas herkent");

                     JLabel pasnummer = new JLabel("This is your card");
                     login_Panel.add(pasnummer);

                     JLabel pasherkend = new JLabel("Voer nu uw pincode in");
                     login_Panel.add(pasherkend);
         ...
         button = new JButton(/*"Login"*/ new AbstractAction("Login") {
             ...
             public void actionPerformed(ActionEvent e) {
                 ...
                 loginCommunicatie(pasnummer, loginwachtwoord);
